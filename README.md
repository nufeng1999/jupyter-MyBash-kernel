...
[Example](https://github.com/nufeng1999/jupyter-MyBash-kernel/blob/master/example/jupyter_MyBash_readme.ipynb "Example")
...
cd jupyter_MyBash_kernel && install_MyBash_kernel --user
